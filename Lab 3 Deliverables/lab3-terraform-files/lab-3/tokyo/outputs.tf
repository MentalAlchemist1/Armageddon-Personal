...
# ==============================================
# LAB 3: TGW OUTPUTS (São Paulo needs these)
# ==============================================

output "tokyo_vpc_cidr" {
  description = "Tokyo VPC CIDR - São Paulo needs this for routing and SG rules"
  value       = aws_vpc.main.cidr_block
}

output "tokyo_tgw_id" {
  description = "Tokyo TGW ID - São Paulo needs this for peering"
  value       = aws_ec2_transit_gateway.shinjuku_tgw01.id
}

output "tokyo_rds_endpoint" {
  description = "Tokyo RDS endpoint - São Paulo EC2 connects here"
  value       = aws_db_instance.main.endpoint
}